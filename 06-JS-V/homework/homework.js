...
function crearUsuario() {
  // 1-Crea una Clase de ES6 o una función constructor llamada "Usuario"
...
function agregarStringInvertida() {
  // 3-Agrega un método al prototype de String que devuelva la misma cadena de caracteres, pero invertida.
  // El método debe llamarse "reverse"
  // Ej: 'menem'.reverse() => menem
  // 'toni'.reverse() => 'inot'
  // Pista: Necesitarás usar "this" dentro de "reverse"
  Invertida.prototype.cadena = function() {
     var cadenaInvertida = ' ';
     var i;
